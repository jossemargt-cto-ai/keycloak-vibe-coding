...
public class PostgreSQLUserAdapter extends AbstractUserAdapter {
    ...
    public Map<String, List<String>> getAttributes() {
        ...
        result.put(FEDERATION_ATTRIBUTE_PREFIX + PostgreSQLUserModel.FIELD_ROLE,
    ...
    public Stream<String> getAttributeStream(String name) {
        if ((FEDERATION_ATTRIBUTE_PREFIX + PostgreSQLUserModel.FIELD_ROLE).equals(name)) {
            String roleId = pgUser.getAttribute(PostgreSQLUserModel.FIELD_ROLE);
            return Stream.of(mapRole(roleId));
        }

        if ((FEDERATION_ATTRIBUTE_PREFIX + PostgreSQLUserModel.FIELD_SUBROLE).equals(name)) {
